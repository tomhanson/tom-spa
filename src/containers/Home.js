					...
					{this.props.pages.about
						? <div className="desk-two-thirds | layout__secondary">
								<div className="layout__secondary | desk-half | flex-center manual-order-high--tablet | padded-border__large text-center ">
									<article
										className="constrained-to-500"
										dangerouslySetInnerHTML={renderHTML(
											this.props.pages.about.acf.about_extra_content
										)}
									/>
								</div>
								<div className="layout__secondary | desk-half | flex-center full-width-img | padded-border__large  text-center">
									<picture>
										<source
											...
											srcSet={`${this.props.pages.about.better_featured_image.media_details.sizes
												.medium_large.source_url}, ${this.props.pages.about.better_featured_image
												.media_details.sizes.large.source_url} 2x`}
										/>
										<source
											srcSet={`${this.props.pages.about.better_featured_image.media_details.sizes
												.large.source_url}, ${this.props.pages.about.better_featured_image
												.source_url} 2x`}
										/>
