		...
		return (
			<Modal style={styles} effect={Effect.ScaleUp}>
				...
				<main className="project">
					<header
						className={`layout__secondary | flex-center | color-bg color-bg-${this.state.current +
							1} | project__header`}
						style={bg}
					>
						<div className="constrained-to-80-percent | project__headline">
							...
							<h5 className="constrained-to-1000 constrained--left | secondary-color">
								{project.acf.project_headline}
								{' '}
							</h5>
						</div>
					</header>
					<section className="contrast-bg | project__brief">
						<div className="constrained-to-80-percent">
							...
							<div
								className="constrained-to-80-percent constrained--left"
								dangerouslySetInnerHTML={renderHTML(project.acf.project_brief)}
							/>
						</div>
					</section>
					{project.acf.project_content_sections.map((article, i) => {
						if (i % 2 === 0) {
							return (
								<article
									key={i}
									className="layout__secondary | flex-center contrast-bg--lighten | project__article"
								>
							...
							return (
								<article
									key={i}
									className="layout__secondary | flex-center contrast-bg | project__article"
								>
					...
					<footer className="text-center | primary">
						<a className="btn btn__primary" href={project.acf.project_url} title={project.title.rendered}>
							Launch Site
						</a>
					</footer>
